...
public class Test03 {
	...
	public void test() throws URISyntaxException {
		...
		body.add("partner_order_id", partner_order_id);//판매자 구분 ID
		body.add("partner_user_id", partner_user_id);//구매자 구분 ID
		body.add("item_name", "아이맥");//명세서에 표시될 구매 내역(다건 구매일 경우 ???외 ?건 형식)
		body.add("quantity", "3");//구매수량
		body.add("total_amount", "990000");//총 구매금액
		...
		//key, value 자료형 지정 안해주면 <Object,Object>
		//log.debug("map = {}", map);
