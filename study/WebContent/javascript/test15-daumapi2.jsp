...
<html>
	...
	<body>
		<div class="container-600">
			<div class="row">
				<input type="text" name="postNumber" placeholder="우편번호" class="form-input form-input-inline">
				<input type="button" onclick="findAddress()" value="우편번호 찾기" class="form-btn form-btn-inline form-btn-positive">	
			</div>
			<div class="row">
